    ...
    return (
        <Col xs={12}
            ...
            <Row className={'m-0 justify-content-between'}>
                <Col lg={2} xs={6} className={'my-3 flex items-center'}>
                ...
                <Col lg={5} xs={12}
                    className={`w-[max-content!important] d-lg-flex items-center order-lg-2 order-3 ${open ? 'w-full' : 'd-none'}`}>
                    <List
                        ...
                        {user && user.data.accountType === 'admin' && (
                            <Link to="/panel"
                                  className={'text-decoration-none ms-lg-5 text-theme-neutral-four cursor-pointer text-[16px]'}>
                                Admin panel
                            </Link>
                ...
                <Col lg={3} xs={6} className={'d-flex align-items-center justify-end order-lg-3 order-2'}>
                    {!user && (
